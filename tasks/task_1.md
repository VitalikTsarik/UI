...
Для тестирования вашей программы имеются 2 графа: [big_graph](https://github.com/KatiaSychik/UI/blob/master/test_graphs/big_graph.json) и [small_graph](https://github.com/KatiaSychik/UI/blob/master/test_graphs/small_graph.json).
